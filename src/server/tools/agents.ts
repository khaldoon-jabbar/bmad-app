import type { Agent, Phase } from '../../shared/types.js';
import { getDashboardState } from './dashboard.js';

const AGENTS: Omit<Agent, 'outputsExist'>[] = [
  {
    id: 'mary',
    name: 'Mary',
    emoji: '📊',
...
export async function handleAgents(projectPath: string): Promise<Agent[]> {
