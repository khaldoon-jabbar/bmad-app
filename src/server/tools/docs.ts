...
import type { DocsInput, DocsOutput } from '../../shared/types.js';
...
export async function handleDocs(input: DocsInput, projectPath: string): Promise<DocsOutput> {
  ...
  if (!filename) return { content: '', title: 'Unknown document' };
